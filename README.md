...
Requires React 17 or later. Pairs with [`@forgelayer-tech/node`](https://github.com/forgelayer-tech/forgelayer-node) on the backend.
...
This package is the frontend half. You need [`@forgelayer-tech/node`](https://github.com/forgelayer-tech/forgelayer-node) on your Express server:
